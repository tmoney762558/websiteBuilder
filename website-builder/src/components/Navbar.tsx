...
const Navbar = () => {
  ...
  return (
    <nav className="lg:block hidden w-full max-w-[12rem] sticky top-0 left-0 min-h-screen bg-yellow-400 border-[1px] border-black text-black font-roboto overflow-y-auto">
